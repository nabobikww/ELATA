document.addEventListener('DOMContentLoaded', () => {
    ...
    const getRoomDetails = (roomName) => {
        ...
        let normalized = roomName.toLowerCase().trim();
        normalized = normalized.replace(/\s*№\d+$/g, '').trim();
        return details[normalized] || details[normalized + " номер"] || "Розкішний номер із бездоганним дизайнерським інтер'єром, обладнаний сучасними зручностями. Повні деталі та характеристики будуть опубліковані найближчим часом.";
    };
